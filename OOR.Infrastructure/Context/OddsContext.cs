...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<League>(entity =>
        {
            ...
            entity.HasOne(d => d.Region).WithMany(p => p.Leagues)
                .HasForeignKey(d => d.RegionId)
                .HasConstraintName("leagues_region_id_fkey");
        ...
        {
            entity.HasKey(e => new { e.MarketId, e.LeagueId, e.SportsbookId }).HasName("market_league_sportsbook_pkey");

            entity.ToTable("market_league_sportsbook");

            entity.Property(e => e.MarketId).HasColumnName("market_id");
            entity.Property(e => e.LeagueId).HasColumnName("league_id");
            entity.Property(e => e.SportsbookId).HasColumnName("sportsbook_id");

            entity.HasOne(d => d.League).WithMany(p => p.MarketLeagueSportsbooks)
                .HasForeignKey(d => d.LeagueId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("market_league_sportsbook_league_id_fkey");

            entity.HasOne(d => d.Market).WithMany(p => p.MarketLeagueSportsbooks)
                .HasForeignKey(d => d.MarketId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("market_league_sportsbook_market_id_fkey");

            entity.HasOne(d => d.Sportsbook).WithMany(p => p.MarketLeagueSportsbooks)
                .HasForeignKey(d => d.SportsbookId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("market_league_sportsbook_sportsbook_id_fkey");
        });
